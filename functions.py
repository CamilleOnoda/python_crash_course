...
# The value 'camille' is an argument: a piece of info passed from a function call to a function.
# The argument 'camille' was passed to the function greet_user() and the value was assigned to the parameter 'username'.


# Positional arguments. Python must match each argument in the function call with a parameter in the function definition.
